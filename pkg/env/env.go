...
// -env dev 表示为本地开发环境，使用的配置信息为：config/dev_config.yaml
// -env fat 表示为测试环境，使用的配置信息为：config/fat_config.yaml
// -env uat 表示为预上线环境，使用的配置信息为：config/uat_config.yaml
// -env pro 表示为正式环境，使用的配置信息为：config/pro_config.yaml
